        ...
        <div id="info-payment-method-{{ paymentMethod.id }}" class="box p-3">
            ...
            <div>
                {% for logo in paymentMethod.logos %}
                    <span>
                        <img src="{{ 'images/empty-placeholder.png' | static_url }}" data-src="{{ logo | payment_new_logo }}" class="lazyload card-img card-img-big" alt="">
                    </span>
                {% endfor %}
            </div>
            ...
            <h4 class="font-weight-normal mb-0">
                ...
                {% if hasDiscount %}
                    ...
                    <strong class="js-installments-one-payment h3 text-primary">{{ priceWithDiscount | money }}</strong>
                {% else %}
